...
class TestPublicAPISync:
  ...
  def test_log_config_is_sync(self):
    ...
    Then: It should be a synchronous function, not async
    """
    assert not inspect.iscoroutinefunction(Baseweb.log_config), "log_config must remain synchronous"
  ...
  def test_log_routes_is_sync(self):
    ...
    Then: It should be a synchronous function, not async
    """
    assert not inspect.iscoroutinefunction(Baseweb.log_routes), "log_routes must remain synchronous"
...
class TestInheritance:
  ...
  def test_baseweb_inherits_from_quart(self):
    ...
    """
    assert issubclass(Baseweb, Quart), "Baseweb must inherit from quart.Quart, not flask.Flask"
